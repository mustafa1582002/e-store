...
$products=$productController->getAllproductswithimg();
?>
              ...
              <?php
                ...
                <li class="menu-item active">
                  <a href="category.php?id=<?php echo $category['id'] ;?>" class="menu-link">
                    <div data-i18n="Vertical Form"><?php echo $category['Name'] ;?></div>
                  </a>
                </li>
                  <?php
                }
              ...
              foreach($products as $product){
                ...
                <div class="col-md-6 col-lg-4 mb-3">
                  <div class="card h-100">
                    <img class="card-img-top" src="<?php echo $product['image']; ?>" alt="Card image cap" width="100px" height="450px" />
                    <div class="card-body">

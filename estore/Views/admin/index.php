        ...
        <div class="layout-page">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted"><?php echo $_SESSION["RoleId"] ?></small>
                          </div>
                        </div>
                      </a>
                    </li>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"> PRODUCT STORE</h4>
              ...
              <div class="card">
                ...
                ?>
                  ...
                  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"> NO Avalable items</button>
                </div>
                  <?php
                    }
                  ...
                  foreach($products as $product){
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <button type="submit" name="delete" id="delete" class="btn btn-icon btn-outline-danger">
